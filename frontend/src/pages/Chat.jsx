...
const Chat = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-card overflow-hidden h-[75vh] flex">
        ...
        >
          <div className="p-4 border-b border-slate-200/80 bg-white">
            ...
            <p className="text-[11px] text-slate-400">Accepted peer mentorship chats</p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto divide-y divide-slate-100">
            {loadingConv ? (
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-4 transition-colors flex items-start gap-3 hover:bg-white ${
                      isSelected ? 'bg-white border-l-4 border-indigo-600 shadow-xs' : ''
                    }`}
                  >
                    <div className="relative flex-shrink-0">
                      {conv.peer?.profileImage ? (
                        ...
                        <div className="w-12 h-12 rounded-2xl bg-indigo-100 text-indigo-700 font-bold flex items-center justify-center text-sm">
              ...
              <div className="p-8 text-center text-slate-400 text-xs">
                ...
                <p className="font-semibold text-slate-600">No active chats yet</p>
                <p className="mt-1">
        ...
        <div className={`flex-1 flex flex-col bg-white ${selectedPeer ? 'flex' : 'hidden md:flex'}`}>
          {selectedPeer ? (
            <>
              {/* Chat Header */}
              <div className="p-4 border-b border-slate-200/80 flex items-center justify-between bg-white z-10">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs px-2.5 py-1 rounded-lg bg-emerald-50 text-emerald-700 font-semibold border border-emerald-100 hidden sm:inline-block">
              ...
              <form onSubmit={handleSendMessage} className="p-3 sm:p-4 border-t border-slate-200 bg-white flex items-center gap-2">
                <input
                  ...
                  className="flex-1 rounded-xl border border-slate-200 text-sm py-2.5 px-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600"
                />
